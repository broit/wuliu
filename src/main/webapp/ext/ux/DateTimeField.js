...
Ext.define('Ext.ux.DateTimeField', {
    ...
    setMinValue : function(value){
        ...
        me.currentMinValue = new Date(minValue.getTime());
        if (picker) {
            picker.minText = Ext.String.format(me.minText, me.formatDate(me.currentMinValue));
    ...
    setMaxValue : function(value){
        ...
        me.currentMaxValue = new Date(maxValue.getTime());
        if (picker) {
            picker.maxText = Ext.String.format(me.maxText, me.formatDate(me.currentMaxValue));
    ...
    getErrors: function(value) {
        value = arguments.length > 0&&arguments!="" ? value : this.formatDate(this.processRawValue(this.getRawValue()));

            // console.log("this.getRawValue()"+this.getRawValue());
        if(this.currentMinValue){
            this.minValue = new Date(this.currentMinValue.getTime());
        }
        if(this.currentMaxValue){
            this.maxValue = new Date(this.currentMaxValue.getTime());
        }
        // console.log("minValue="+this.minValue+" and "+"maxValue="+this.maxValue);
        var me = this,
            format = Ext.String.format,
            // clearTime = Ext.Date.clearTime,
            clearTime = function(time){return time},
            errors = me.callParent([value]),
            disabledDays = me.disabledDays,
            disabledDatesRE = me.disabledDatesRE,
            minValue = me.currentMinValue,
            maxValue = me.currentMaxValue,
            ...
            day,
            time;
        // console.log("minValue="+this.currentMinValue+" and "+"maxValue="+this.currentMaxValue);
        ...
        time = value.getTime();
        // console.log(minValue && time < clearTime(minValue).getTime());
        if (minValue && time < clearTime(minValue).getTime()) {
            errors.push(format(me.minText, me.formatDate(minValue)));
        }

        // console.log(maxValue && time > clearTime(maxValue).getTime());
